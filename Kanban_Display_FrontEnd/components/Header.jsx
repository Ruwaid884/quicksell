...
const Header = ({sortTickets,groupTickets,groupby,orderby}) => {
    ...
    return <>
       ...
       <div>
       <div style={{ height: "50px", width: "100%", display: "flex", alignItems: "center",backgroundColor:"white" }}>
       <button onClick={handleOpenDisplay} style={{ 
    padding: "8px 6px", // Increased padding for a larger button
    marginLeft: "40px",
    display: "flex",
    alignItems: "center",
    justifyContent: "space-evenly",
    borderRadius: "8px", // Slightly larger rounded corners
